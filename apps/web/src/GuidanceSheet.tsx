...
export default function GuidanceSheet() {
  return (
    <div className="guidance-sheet">
      ...
      <div className="guidance-warning" role="note" aria-label="식품 상태 확인 안내"><LightningBoltIcon width={16} height={16} /><span style={{ display: "grid", gap: 2 }}><strong>상태가 이상하면 날짜보다 먼저 확인해요</strong><small>냄새·색·포장 팽창 등이 있으면 날짜와 관계없이 먹지 말고 폐기 여부를 확인하세요.</small></span></div>
    </div>
  );
}
